...
class LAMMask2FormerModel(nn.Module):
    ...
    def decode_semantic_logits(self, decoder_outputs, image_size):
        """MODIFIED: centralize semantic decoding for inference and validation metrics."""
        return self.mask2former_decoder.get_semantic_segmentation(decoder_outputs, image_size)

    def forward(self, images, compute_cov_loss=False, return_decoder_outputs=False):
        """
        前向传播
        ...
        logits = self.decode_semantic_logits(outputs, (H, W))
